...
xcopy "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Redist\MSVC\14.27.29016\x86\Microsoft.VC142.CRT\*" "%TmpDir%\32bit\" || exit /B 1
xcopy "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Redist\MSVC\14.27.29016\x86\Microsoft.VC142.MFC\*" "%TmpDir%\32bit\" || exit /B 1
xcopy "C:\Program Files (x86)\Windows Kits\10\Debuggers\x86\dbghelp.dll" "%TmpDir%\32bit\" || exit /B 1
xcopy "C:\Program Files (x86)\Windows Kits\10\Redist\10.0.19041.0\ucrt\DLLs\x86\*" "%TmpDir%\32bit\" || exit /B 1
...
xcopy "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Redist\MSVC\14.27.29016\x64\Microsoft.VC142.CRT\*" "%TmpDir%\64bit\" || exit /B 1
xcopy "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Redist\MSVC\14.27.29016\x64\Microsoft.VC142.MFC\*" "%TmpDir%\64bit\" || exit /B 1
xcopy "C:\Program Files (x86)\Windows Kits\10\Debuggers\x64\dbghelp.dll" "%TmpDir%\64bit\" || exit /B 1
xcopy "C:\Program Files (x86)\Windows Kits\10\Redist\10.0.19041.0\ucrt\DLLs\x64\*" "%TmpDir%\64bit\" || exit /B 1
...
xcopy "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Redist\MSVC\14.27.29016\x86\Microsoft.VC142.CRT\*" "%TmpDir%\64bit\ShellExt32\" || exit /B 1
xcopy "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Redist\MSVC\14.27.29016\x86\Microsoft.VC142.MFC\*" "%TmpDir%\64bit\ShellExt32\" || exit /B 1
xcopy "C:\Program Files (x86)\Windows Kits\10\Debuggers\x86\dbghelp.dll" "%TmpDir%\64bit\ShellExt32\" || exit /B 1
xcopy "C:\Program Files (x86)\Windows Kits\10\Redist\10.0.19041.0\ucrt\DLLs\x86\*" "%TmpDir%\64bit\ShellExt32\" || exit /B 1
