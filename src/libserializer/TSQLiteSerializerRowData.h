...
namespace serializer
{
	...
	class LIBSERIALIZER_API TSQLiteSerializerRowData : public ISerializerRowData
	{
	private:
	...
	public:
		...
		ISerializerRowData& SetValue(size_t stColIndex, const string::TString& strValue) override;
		ISerializerRowData& SetValue(size_t stColIndex, const chcore::TSmartPath& pathValue) override;
		...
		ISerializerRowData& SetValue(const wchar_t* strColumnName, const string::TString& strValue) override;
		ISerializerRowData& SetValue(const wchar_t* strColumnName, const chcore::TSmartPath& pathValue) override;

		string::TString GetQuery(const string::TString& strContainerName) const;
