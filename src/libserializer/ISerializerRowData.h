...
namespace serializer
{
	...
	class LIBSERIALIZER_API ISerializerRowData
	{
	public:
		...
		virtual ISerializerRowData& SetValue(size_t stColIndex, const string::TString& strValue) = 0;
		virtual ISerializerRowData& SetValue(size_t stColIndex, const chcore::TSmartPath& pathValue) = 0;
		...
		virtual ISerializerRowData& SetValue(const wchar_t* strColumnName, const string::TString& strValue) = 0;
		virtual ISerializerRowData& SetValue(const wchar_t* strColumnName, const chcore::TSmartPath& pathValue) = 0;
	};
}
