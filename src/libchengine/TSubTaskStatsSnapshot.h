...
namespace chengine
{
	class LIBCHENGINE_API TSubTaskStatsSnapshot
	{
	public:
		...
		// current path
		void SetCurrentPath(const string::TString& strPath) { m_strCurrentPath = strPath; }
		const string::TString& GetCurrentPath() const { return m_strCurrentPath; }
	...
	private:
		...
		string::TString m_strCurrentPath;		// currently processed path
