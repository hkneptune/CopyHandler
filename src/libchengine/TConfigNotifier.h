...
namespace chengine
{
	...
	{
	public:
		TConfigNotifier(void(*pfnCallback)(const string::TStringSet&, void*), void* pParam);
		~TConfigNotifier();

		void operator()(const string::TStringSet& rsetPropNames);
	...
	private:
		void(*m_pfnCallback)(const string::TStringSet&, void*);
		void* m_pParam;
	};
}
