...
namespace chengine
{
	class LIBCHENGINE_API TSubTaskArrayStatsSnapshot
	{
	public:
		...
		serializer::object_id_t GetCurrentSubtaskIndex() const { return m_oidCurrentSubtaskIndex; }
		void SetCurrentSubtaskIndex(serializer::object_id_t val) { m_oidCurrentSubtaskIndex = val; }

	private:
		serializer::object_id_t m_oidCurrentSubtaskIndex;
#pragma warning(push)
